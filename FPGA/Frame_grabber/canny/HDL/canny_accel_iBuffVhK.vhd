...
entity canny_accel_iBuffVhK_ram is 
    generic(
...
architecture rtl of canny_accel_iBuffVhK_ram is 
...
entity canny_accel_iBuffVhK is
    generic (
...
architecture arch of canny_accel_iBuffVhK is
    component canny_accel_iBuffVhK_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    canny_accel_iBuffVhK_ram_U :  component canny_accel_iBuffVhK_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
