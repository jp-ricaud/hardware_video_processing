...
architecture behav of ip_accel_app is 
    ...
    "ip_accel_app,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcku035-fbva676-2-e,HLS_INPUT_CLOCK=1.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=2.881000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=324,HLS_SYN_DSP=6,HLS_SYN_FF=298413,HLS_SYN_LUT=146378,HLS_VERSION=2019_1}";
    ...
    component start_for_canny_achv IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_xfMat2Aciv IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    start_for_canny_achv_U : component start_for_canny_achv
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_xfMat2Aciv_U : component start_for_xfMat2Aciv
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
