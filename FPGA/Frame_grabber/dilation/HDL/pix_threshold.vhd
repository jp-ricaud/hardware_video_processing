...
architecture behav of pix_threshold is 
    ...
    "pix_threshold,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xcku035-fbva676-2-e,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=1.200000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=1931,HLS_SYN_LUT=951,HLS_VERSION=2019_1}";
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                elsif ((not(((ap_const_lv2_1 = VideoOut_V_User_V_1_state) or (ap_const_lv2_1 = VideoOut_V_Data_V_1_state) or ((ap_const_lv2_3 = VideoOut_V_User_V_1_state) and (ap_const_logic_0 = VideoOut_TREADY)) or ((ap_const_lv2_3 = VideoOut_V_Data_V_1_state) and (ap_const_logic_0 = VideoOut_TREADY)))) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
                    MetaIn_DsizeL_V_ap_vld_preg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                elsif ((((ap_const_lv2_1 = VideoOut_V_Data_V_1_state) and (ap_const_logic_0 = VideoOut_TREADY)) or ((ap_const_lv2_3 = VideoOut_V_Data_V_1_state) and (ap_const_logic_0 = VideoOut_TREADY) and (ap_const_logic_1 = VideoOut_V_Data_V_1_vld_in)))) then 
                    VideoOut_V_Data_V_1_state <= ap_const_lv2_1;
                elsif (((not(((ap_const_logic_0 = VideoOut_V_Data_V_1_vld_in) and (ap_const_logic_1 = VideoOut_V_Data_V_1_ack_out))) and not(((ap_const_logic_0 = VideoOut_TREADY) and (ap_const_logic_1 = VideoOut_V_Data_V_1_vld_in))) and (ap_const_lv2_3 = VideoOut_V_Data_V_1_state)) or ((ap_const_lv2_1 = VideoOut_V_Data_V_1_state) and (ap_const_logic_1 = VideoOut_V_Data_V_1_ack_out)) or ((ap_const_lv2_2 = VideoOut_V_Data_V_1_state) and (ap_const_logic_1 = VideoOut_V_Data_V_1_vld_in)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                elsif ((((ap_const_lv2_1 = VideoOut_V_User_V_1_state) and (ap_const_logic_0 = VideoOut_TREADY)) or ((ap_const_lv2_3 = VideoOut_V_User_V_1_state) and (ap_const_logic_0 = VideoOut_TREADY) and (ap_const_logic_1 = VideoOut_V_User_V_1_vld_in)))) then 
                    VideoOut_V_User_V_1_state <= ap_const_lv2_1;
                elsif (((not(((ap_const_logic_0 = VideoOut_V_User_V_1_vld_in) and (ap_const_logic_1 = VideoOut_V_User_V_1_ack_out))) and not(((ap_const_logic_0 = VideoOut_TREADY) and (ap_const_logic_1 = VideoOut_V_User_V_1_vld_in))) and (ap_const_lv2_3 = VideoOut_V_User_V_1_state)) or ((ap_const_lv2_1 = VideoOut_V_User_V_1_state) and (ap_const_logic_1 = VideoOut_V_User_V_1_ack_out)) or ((ap_const_lv2_2 = VideoOut_V_User_V_1_state) and (ap_const_logic_1 = VideoOut_V_User_V_1_vld_in)))) then 
    ...
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state4 => 
                if ((not(((ap_const_lv2_1 = VideoOut_V_User_V_1_state) or (ap_const_lv2_1 = VideoOut_V_Data_V_1_state) or ((ap_const_lv2_3 = VideoOut_V_User_V_1_state) and (ap_const_logic_0 = VideoOut_TREADY)) or ((ap_const_lv2_3 = VideoOut_V_Data_V_1_state) and (ap_const_logic_0 = VideoOut_TREADY)))) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state4;
                end if;
    ...
    ap_block_state4_assign_proc : process(VideoOut_TREADY, VideoOut_V_Data_V_1_state, VideoOut_V_User_V_1_state)
    begin
                ap_block_state4 <= ((ap_const_lv2_1 = VideoOut_V_User_V_1_state) or (ap_const_lv2_1 = VideoOut_V_Data_V_1_state) or ((ap_const_lv2_3 = VideoOut_V_User_V_1_state) and (ap_const_logic_0 = VideoOut_TREADY)) or ((ap_const_lv2_3 = VideoOut_V_Data_V_1_state) and (ap_const_logic_0 = VideoOut_TREADY)));
    end process;


    ap_done_assign_proc : process(VideoOut_TREADY, VideoOut_V_Data_V_1_state, VideoOut_V_User_V_1_state, ap_CS_fsm_state4)
    begin
        if ((not(((ap_const_lv2_1 = VideoOut_V_User_V_1_state) or (ap_const_lv2_1 = VideoOut_V_Data_V_1_state) or ((ap_const_lv2_3 = VideoOut_V_User_V_1_state) and (ap_const_logic_0 = VideoOut_TREADY)) or ((ap_const_lv2_3 = VideoOut_V_Data_V_1_state) and (ap_const_logic_0 = VideoOut_TREADY)))) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    ap_ready_assign_proc : process(VideoOut_TREADY, VideoOut_V_Data_V_1_state, VideoOut_V_User_V_1_state, ap_CS_fsm_state4)
    begin
        if ((not(((ap_const_lv2_1 = VideoOut_V_User_V_1_state) or (ap_const_lv2_1 = VideoOut_V_Data_V_1_state) or ((ap_const_lv2_3 = VideoOut_V_User_V_1_state) and (ap_const_logic_0 = VideoOut_TREADY)) or ((ap_const_lv2_3 = VideoOut_V_Data_V_1_state) and (ap_const_logic_0 = VideoOut_TREADY)))) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
