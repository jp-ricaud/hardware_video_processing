...
architecture behav of ip_accel_app is
    ...
    "ip_accel_app,hls_ip_2019_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcku035-fbva676-2-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=8.225500,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=3,HLS_SYN_DSP=0,HLS_SYN_FF=3937,HLS_SYN_LUT=3616,HLS_VERSION=2019_1}";
    ...
    signal Block_Mat_exit615_pr_U0_imgInput1_rows_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit615_pr_U0_imgInput1_rows_out_write : STD_LOGIC;
    signal Block_Mat_exit615_pr_U0_imgInput1_cols_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit615_pr_U0_imgInput1_cols_out_write : STD_LOGIC;
    signal Block_Mat_exit615_pr_U0_imgOutput1_rows_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit615_pr_U0_imgOutput1_rows_out_write : STD_LOGIC;
    signal Block_Mat_exit615_pr_U0_imgOutput1_cols_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit615_pr_U0_imgOutput1_cols_out_write : STD_LOGIC;
    ...
    signal dilation_accel_U0_kernel_address0 : STD_LOGIC_VECTOR (3 downto 0);
    signal dilation_accel_U0_kernel_ce0 : STD_LOGIC;
    ...
    signal imgInput1_rows_c25_full_n : STD_LOGIC;
    signal imgInput1_rows_c25_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal imgInput1_rows_c25_empty_n : STD_LOGIC;
    signal imgInput1_cols_c26_full_n : STD_LOGIC;
    signal imgInput1_cols_c26_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal imgInput1_cols_c26_empty_n : STD_LOGIC;
    ...
    signal ap_sync_reg_dilation_accel_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_dilation_accel_U0_ap_ready : STD_LOGIC;
    signal dilation_accel_U0_ap_ready_count : STD_LOGIC_VECTOR (1 downto 0) := "00";
...
begin
    ...
    port map (
        ...
        imgInput1_rows_out_din => Block_Mat_exit615_pr_U0_imgInput1_rows_out_din,
        imgInput1_rows_out_full_n => imgInput1_rows_c_full_n,
        imgInput1_rows_out_write => Block_Mat_exit615_pr_U0_imgInput1_rows_out_write,
        imgInput1_cols_out_din => Block_Mat_exit615_pr_U0_imgInput1_cols_out_din,
        imgInput1_cols_out_full_n => imgInput1_cols_c_full_n,
        imgInput1_cols_out_write => Block_Mat_exit615_pr_U0_imgInput1_cols_out_write,
        imgOutput1_rows_out_din => Block_Mat_exit615_pr_U0_imgOutput1_rows_out_din,
        imgOutput1_rows_out_full_n => imgOutput1_rows_c_full_n,
        imgOutput1_rows_out_write => Block_Mat_exit615_pr_U0_imgOutput1_rows_out_write,
        imgOutput1_cols_out_din => Block_Mat_exit615_pr_U0_imgOutput1_cols_out_din,
        imgOutput1_cols_out_full_n => imgOutput1_cols_c_full_n,
        imgOutput1_cols_out_write => Block_Mat_exit615_pr_U0_imgOutput1_cols_out_write,
    ...
    port map (
        ...
        p_src_rows_dout => imgInput1_rows_c25_dout,
        p_src_rows_empty_n => imgInput1_rows_c25_empty_n,
        p_src_rows_read => dilation_accel_U0_p_src_rows_read,
        p_src_cols_dout => imgInput1_cols_c26_dout,
        p_src_cols_empty_n => imgInput1_cols_c26_empty_n,
        p_src_cols_read => dilation_accel_U0_p_src_cols_read,
        p_src_data_V_dout => imgInput1_data_V_dout,
        p_src_data_V_empty_n => imgInput1_data_V_empty_n,
        p_src_data_V_read => dilation_accel_U0_p_src_data_V_read,
        p_dst_data_V_din => dilation_accel_U0_p_dst_data_V_din,
        p_dst_data_V_full_n => imgOutput1_data_V_full_n,
        p_dst_data_V_write => dilation_accel_U0_p_dst_data_V_write,
        kernel_address0 => dilation_accel_U0_kernel_address0,
        kernel_ce0 => dilation_accel_U0_kernel_ce0,
        kernel_q0 => kernel_q0);
    ...
    port map (
        ...
        if_din => Block_Mat_exit615_pr_U0_imgInput1_rows_out_din,
        if_full_n => imgInput1_rows_c_full_n,
        if_write => Block_Mat_exit615_pr_U0_imgInput1_rows_out_write,
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Block_Mat_exit615_pr_U0_imgInput1_cols_out_din,
        if_full_n => imgInput1_cols_c_full_n,
        if_write => Block_Mat_exit615_pr_U0_imgInput1_cols_out_write,
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Block_Mat_exit615_pr_U0_imgOutput1_rows_out_din,
        if_full_n => imgOutput1_rows_c_full_n,
        if_write => Block_Mat_exit615_pr_U0_imgOutput1_rows_out_write,
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Block_Mat_exit615_pr_U0_imgOutput1_cols_out_din,
        if_full_n => imgOutput1_cols_c_full_n,
        if_write => Block_Mat_exit615_pr_U0_imgOutput1_cols_out_write,
    ...
    imgInput1_rows_c25_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        ...
        if_full_n => imgInput1_rows_c25_full_n,
        if_write => AXIvideo2xfMat_U0_img_rows_out_write,
        if_dout => imgInput1_rows_c25_dout,
        if_empty_n => imgInput1_rows_c25_empty_n,
        if_read => dilation_accel_U0_p_src_rows_read);

    imgInput1_cols_c26_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        ...
        if_full_n => imgInput1_cols_c26_full_n,
        if_write => AXIvideo2xfMat_U0_img_cols_out_write,
        if_dout => imgInput1_cols_c26_dout,
        if_empty_n => imgInput1_cols_c26_empty_n,
    ...
    ap_sync_reg_dilation_accel_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ap_sync_reg_dilation_accel_U0_ap_ready <= ap_const_logic_0;
            else
                if (((ap_sync_ready and ap_start) = ap_const_logic_1)) then
                    ap_sync_reg_dilation_accel_U0_ap_ready <= ap_const_logic_0;
                else
                    ap_sync_reg_dilation_accel_U0_ap_ready <= ap_sync_dilation_accel_U0_ap_ready;
                end if;
            end if;
        end if;
    end process;
    ...
    dilation_accel_U0_ap_ready_count_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((dilation_accel_U0_ap_ready = ap_const_logic_0) and (ap_sync_ready = ap_const_logic_1))) then
                dilation_accel_U0_ap_ready_count <= std_logic_vector(unsigned(dilation_accel_U0_ap_ready_count) - unsigned(ap_const_lv2_1));
            elsif (((ap_sync_ready = ap_const_logic_0) and (dilation_accel_U0_ap_ready = ap_const_logic_1))) then
                dilation_accel_U0_ap_ready_count <= std_logic_vector(unsigned(dilation_accel_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if;
        end if;
    end process;
    ...
    ap_sync_dilation_accel_U0_ap_ready <= (dilation_accel_U0_ap_ready or ap_sync_reg_dilation_accel_U0_ap_ready);
    ap_sync_done <= (xfMat2AXIvideo_U0_ap_done and Block_Mat_exit61516_U0_ap_done);
    ap_sync_ready <= (ap_sync_dilation_accel_U0_ap_ready and ap_sync_Block_Mat_exit615_pr_U0_ap_ready and ap_sync_AXIvideo2xfMat_U0_ap_ready);
    dilation_accel_U0_ap_continue <= ap_const_logic_1;
    dilation_accel_U0_ap_start <= ((ap_sync_reg_dilation_accel_U0_ap_ready xor ap_const_logic_1) and ap_start);
