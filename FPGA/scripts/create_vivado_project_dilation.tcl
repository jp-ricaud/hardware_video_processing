...
proc customlogicCreateProject {} {
  ...
  # Create project
  create_project $project_name $customlogic_dir/07_vivado_project_dilation -part xcku035-fbva676-2-e
  ...
  set files [list \
    ...
    "[file normalize "$customlogic_dir/04_ref_design/dilation/frame_to_line.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/dilation/mem_traffic_gen.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/dilation/control_registers.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/dilation/pix_lut8b.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/dilation/pix_threshold_proc.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/dilation/pix_threshold.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/dilation/pix_threshold_wrp.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/dilation/CustomLogic.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/dilation/lut_bram_8x256.xcix"]"\
    "[file normalize "$customlogic_dir/04_ref_design/dilation/sim/onboardmem.xcix"]"\
    "[file normalize "$customlogic_dir/04_ref_design/dilation/AXIvideo2xfMat.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/dilation/Block_Mat_exit61516_s.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/dilation/Block_Mat_exit615_pr.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/dilation/Block_Mat_exit61_pro.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/dilation/dilate.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/dilation/dilation_accel.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/dilation/fifo_w16_d2_A.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/dilation/fifo_w24_d2_A.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/dilation/fifo_w32_d2_A.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/dilation/fifo_w32_d4_A.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/dilation/fifo_w8_d1_A.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/dilation/fifo_w8_d2_A.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/dilation/ip_accel_app.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/dilation/ip_accel_app_mux_bkb.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/dilation/start_for_xfMat2Acud.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/dilation/xfExtractPixels.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/dilation/xfMat2AXIvideo.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/dilation/xfdilate.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/dilation/xfdilate_buf_0_V.vhd"]"\
  ]
  ...
  set files [list \
    ...
    "[file normalize "$customlogic_dir/04_ref_design/dilation/CustomLogic.xdc"]"\
  ]
  add_files -norecurse -fileset $obj $files

  # Set 'constrs_1' fileset properties
  set obj [get_filesets constrs_1]
  set_property "target_constrs_file" "[file normalize "$customlogic_dir/04_ref_design/dilation/CustomLogic.xdc"]" $obj
  ...
  set files [list \
    "[file normalize "$customlogic_dir/04_ref_design/dilation/sim/CustomLogicSimPkt.vhdp"]" \
    "[file normalize "$customlogic_dir/04_ref_design/dilation/sim/SimulationCtrl_tb.vhd"]" \
    "[file normalize "$customlogic_dir/04_ref_design/dilation/sim/tb_top.vhd"]" \
    "[file normalize "$customlogic_dir/04_ref_design/dilation/sim/tb_top_behav.wcfg"]" \
  ]
  add_files -norecurse -fileset $obj $files
  ...
  set_property used_in_synthesis false [get_files "$customlogic_dir/04_ref_design/dilation/sim/onboardmem/onboardmem.xci"]
  set_property used_in_implementation false [get_files "$customlogic_dir/04_ref_design/dilation/sim/onboardmem/onboardmem.xci"]
  set_property used_in_simulation true [get_files "$customlogic_dir/04_ref_design/dilation/sim/onboardmem/onboardmem.xci"]
