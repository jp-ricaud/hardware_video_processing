...
proc customlogicCreateProject {} {
  ...
  set files [list \
    ...
    "[file normalize "$customlogic_dir/04_ref_design/threshold/frame_to_line.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/threshold/mem_traffic_gen.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/threshold/control_registers.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/threshold/pix_lut8b.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/threshold/pix_threshold_wrp.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/threshold/CustomLogic.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/threshold/lut_bram_8x256.xcix"]"\
    "[file normalize "$customlogic_dir/04_ref_design/threshold/sim/onboardmem.xcix"]"\
    "[file normalize "$customlogic_dir/04_ref_design/threshold/AXIvideo2xfMat.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/threshold/Block_Mat_exit61516_s.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/threshold/Block_Mat_exit615_pr.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/threshold/Threshold.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/threshold/fifo_w16_d2_A.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/threshold/fifo_w24_d2_A.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/threshold/fifo_w32_d2_A.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/threshold/fifo_w32_d4_A.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/threshold/fifo_w8_d1_A.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/threshold/fifo_w8_d2_A.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/threshold/fifo_w8_d3_A.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/threshold/ip_accel_app.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/threshold/start_for_threshobkb.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/threshold/start_for_xfMat2Acud.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/threshold/threshold_accel.vhd"]"\
    "[file normalize "$customlogic_dir/04_ref_design/threshold/xfMat2AXIvideo.vhd"]"\
  ]
  ...
  set files [list \
    ...
    "[file normalize "$customlogic_dir/04_ref_design/threshold/CustomLogic.xdc"]"\
  ]
  add_files -norecurse -fileset $obj $files

  # Set 'constrs_1' fileset properties
  set obj [get_filesets constrs_1]
  set_property "target_constrs_file" "[file normalize "$customlogic_dir/04_ref_design/threshold/CustomLogic.xdc"]" $obj
  ...
  set files [list \
    "[file normalize "$customlogic_dir/04_ref_design/threshold/sim/CustomLogicSimPkt.vhdp"]" \
    "[file normalize "$customlogic_dir/04_ref_design/threshold/sim/SimulationCtrl_tb.vhd"]" \
    "[file normalize "$customlogic_dir/04_ref_design/threshold/sim/tb_top.vhd"]" \
    "[file normalize "$customlogic_dir/04_ref_design/threshold/sim/tb_top_behav.wcfg"]" \
  ]
  add_files -norecurse -fileset $obj $files
  ...
  set_property used_in_synthesis false [get_files "$customlogic_dir/04_ref_design/threshold/sim/onboardmem/onboardmem.xci"]
  set_property used_in_implementation false [get_files "$customlogic_dir/04_ref_design/threshold/sim/onboardmem/onboardmem.xci"]
  set_property used_in_simulation true [get_files "$customlogic_dir/04_ref_design/threshold/sim/onboardmem/onboardmem.xci"]
